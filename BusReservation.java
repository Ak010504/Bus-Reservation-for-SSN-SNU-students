...
public class BusReservation {
    public static void main(String[] args) {
        ...
        ImageIcon backgroundImage = new ImageIcon("D:\\Amrit\\College\\SSN\\CS\\bus reservation\\Bus-Reservation-System.jpg");
        ...
        // ssn image
        ImageIcon ssn = new ImageIcon("D:\\Amrit\\College\\SSN\\CS\\bus reservation\\ssn.jpg");
     ...
     Ssn_Details_register() {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String line;
                int count=0;
                String ssn_file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\ssn_details.csv";
     ...
     Snu_Details_register() {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int count=0;
                String line;
                String snu_file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\snu_details.csv";
...
class Reserve_cancel_ssn{
    ...
    String[] parts = lines.get(i).split(",");
                ...
                String bus_file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\reservation_1.csv";
...
class Reserve_cancel_snu{
    ...
    Reserve_cancel_snu(String login_name){
        String ssn_file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\snu_details.csv";
                List<String> lines3 = new ArrayList<>();
                try(BufferedReader reader3 = new BufferedReader(new FileReader(ssn_file))){
                    String line3;
                    while ((line3 = reader3.readLine()) != null) {
...
class Reservation{
    ...
    Reservation(Object chosen_bus, String login_name, int flag){
         List<String> lines = new ArrayList<>();
        String ssn_file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\reservation_1.csv";
                try (BufferedReader reader = new BufferedReader(new FileReader(ssn_file))){
                    String line;
                    while ((line = reader.readLine()) != null) {
                        lines.add(line);
    ...
    if (parts[0].trim().equals(String.valueOf(chosen_bus))) {
        ...
        if (flag == 0){
         List<String> lines2 = new ArrayList<>();
                String file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\ssn_details.csv";
        ...
        List<String> lines2 = new ArrayList<>();
                String file = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\snu_details.csv";
                try (BufferedReader reader2 = new BufferedReader(new FileReader(file))){
                    String line2;
                    while ((line2 = reader2.readLine()) != null) {
                        lines2.add(line2);
    ...
    Ssn_Bus_routes(String login_name){
        ...
        ssn_button_route.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                ...
                String bus_route_path = "D:\\Amrit\\College\\SSN\\CS\\bus reservation\\Bus Routes.pdf";
